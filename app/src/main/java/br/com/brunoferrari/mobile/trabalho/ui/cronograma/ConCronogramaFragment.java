...
public class ConCronogramaFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.view = inflater.inflate(R.layout.fragment_con_cronograma_list, container, false);
        ...
        cronograma.setCliente(" ");
        //incluindo objeto no array de envio
        jsonArray.put(cronograma.toJsonObject());
                ...
                */
                if (view instanceof RecyclerView) {
                    ...
                    recyclerView.setAdapter(
                            new CronogramaRecyclerViewAdapter(this.cronogramas));
                }
            }else {
                Snackbar mensagem = Snackbar.make(view,
